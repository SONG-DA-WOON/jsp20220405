...
<body>
	<h1>여러 영역에서 중복된 Attribute 명이 존재 할 때</h1>
	...
	request.setAttribute("attr2", "page attribute2");
	session.setAttribute("attr2", "sessopn attribute2");
	application.setAttribute("attr2", "application attribute2");
	
	session.setAttribute("attr3", "session attribute3");
	application.setAttribute("attr3", "applicaion attribute3");
